...
featured: true,
  ...
  {
slug: "lead-glass-goggles",
name: "Lead Glass Goggles",
category: "radiation-safety-equipment",
model: "Lead Glass Goggles",
shortDescription: "Radiation protective lead glass goggles designed to shield the eyes from X-ray radiation during radiographic and industrial inspection procedures.",
description:
"Lead Glass Goggles are radiation protection eyewear designed to reduce exposure of the eyes to scattered X-ray radiation. The lead glass lenses provide radiation shielding while maintaining visibility, making them suitable for personnel working around X-ray and radiographic equipment. They can be used in medical, laboratory, industrial, and non-destructive testing environments.",
images: [
"https://img2.exportersindia.com/product_images/bc-500/dir_12/338865/lead-glass-goggles-1358997.jpg",
],
specs: [
{ label: "Product Type", value: "Radiation Protective Lead Glass Goggles" },
{ label: "Protection", value: "X-Ray Radiation Shielding" },
{ label: "Lens Material", value: "Lead Glass" },
{ label: "Application", value: "Radiographic and Industrial Inspection" },
{ label: "Design", value: "Protective Goggles" },
],
features: [
"Lead glass radiation shielding lenses",
"Designed to protect the eyes from scattered X-ray radiation",
"Provides clear visibility during inspection",
"Protective eyewear design",
"Suitable for radiographic environments",
"Suitable for medical, laboratory, and industrial applications",
],
applications: [
...
featured: false,
  ...
  {
slug: "x-ray-protective-lead-gloves",
name: "X-Ray Protective Lead Gloves",
category: "radiation-safety-equipment",
model: "Lead Protective Gloves",
shortDescription: "Radiation protective lead gloves designed to reduce exposure to scattered X-ray radiation during radiographic and industrial inspection procedures.",
description:
"The X-Ray Protective Lead Gloves are radiation shielding gloves designed to protect the hands from scattered X-ray radiation during radiographic procedures. They are suitable for medical, dental, laboratory, and industrial non-destructive testing environments where personnel may be exposed to secondary radiation. Lead-equivalent protective gloves are available in different shielding levels depending on the application.",
images: [
"https://img2.exportersindia.com/product_images/bc-500/dir_12/338865/x-ray-protective-lead-gloves-1359008.jpg",
],
specs: [
{ label: "Product Type", value: "X-Ray Protective Lead Gloves" },
{ label: "Protection", value: "X-Ray Radiation Shielding" },
{ label: "Application", value: "Medical, Dental, Laboratory and Industrial NDT" },
{ label: "Design", value: "Radiation Protective Gloves" },
{ label: "Lead Equivalency", value: "Typically 0.25 mm Pb to 0.50 mm Pb" },
],
features: [
"Designed for X-ray radiation protection",
"Protects hands from scattered radiation",
"Flexible protective glove design",
"Suitable for radiographic inspection environments",
"Available in different lead-equivalent shielding levels",
...
featured: false,
  ...
  {
slug: "x-ray-protective-lead-single-sided-apron",
name: "X Ray Protective Lead Single Sided Apron",
category: "radiation-safety-equipment",
model: "Single Sided Lead Apron",
shortDescription: "Single-sided lead protective apron designed to provide radiation shielding during X-ray and industrial radiographic inspection procedures.",
description:
"The X Ray Protective Lead Single Sided Apron is a protective garment designed to reduce exposure to scattered X-ray radiation during radiographic procedures. Its single-sided design provides protection to the front of the wearer and is suitable for applications in medical imaging, dental procedures, and industrial non-destructive testing. Lead aprons are commonly used as radiation protection when personnel need to remain near an X-ray source or patient during exposure. :contentReference[oaicite:0]{index=0}",
images: [
"https://img2.exportersindia.com/product_images/bc-500/dir_12/338865/x-ray-protective-lead-single-sided-apron-1359002.jpg",
],
specs: [
{ label: "Product Type", value: "X Ray Protective Lead Apron" },
{ label: "Apron Type", value: "Single Sided" },
{ label: "Protection", value: "X-Ray Radiation Shielding" },
{ label: "Design", value: "Front-Side Protection" },
{ label: "Application", value: "Medical, Dental and Industrial NDT" },
],
features: [
"Single-sided protective design",
"Designed for X-ray radiation protection",
"Provides front-side shielding",
"Suitable for medical and industrial applications",
"Suitable for radiographic inspection environments",
...
featured: true,
  ...
  {
slug: "smartrad-micro-contamination-monitor",
name: "SmartRad Micro Next Generation Contamination Monitor",
category: "radiation-safety-equipment",
model: "SmartRad Micro",
shortDescription: "Portable radiation contamination monitor designed for detecting Alpha, Beta, Gamma, and X-ray radiation in surface contamination and industrial monitoring applications.",
description:
"The SmartRad Micro is a next-generation portable radiation contamination monitor designed for detecting and measuring Alpha, Beta, Gamma, and X-ray radiation. It uses an externally mounted halogen-quenched pancake GM detector and provides rate, SI, and dose measurements through a graphic LCD display. Its compact design makes it suitable for surface contamination monitoring, research laboratories, scrap material inspection, and other radiation safety applications.",
images: [
"https://www.pulsecho.com/img/resources/smartrad-micro-productimg.jpg",
],
specs: [
{ label: "Product Type", value: "Radiation Contamination Monitor" },
{ label: "Model", value: "SmartRad Micro" },
{ label: "Application", value: "Radiation Contamination Detection" },
{ label: "Suitable For", value: "Surface Contamination Monitoring, Research Laboratories, Scrap Material" },
{ label: "Radiation Detected", value: "Alpha, Beta, Gamma and X-ray" },
{ label: "Detector", value: "Externally Mounted Halogen-Quenched Pancake GM Detector" },
{ label: "Detector Model", value: "LND 7312" },
{ label: "Detector Size", value: "1.75 inch Diameter x 0.5 inch Depth" },
{ label: "Alpha/Beta Shield", value: "Openable" },
{ label: "Beta Detection Window", value: "1.5 mg/cm², Approx. 2 inch Diameter x 0.5 inch Depth" },
{ label: "Measuring Range - Rate", value: "10 µR/h to 100 mR/h and 0-6000 CPS" },
{ label: "SI Range", value: "0.01 µSv/h to 999 µSv/h and 0-6000 CPS" },
{ label: "Dose Range", value: "0.01 mR to 999 mR; 0.01 µSv to 999 µSv" },
{ label: "Energy Response", value: "10 keV to 2 MeV" },
{ label: "Accuracy", value: "±15% when calibrated with Cs-137" },
{ label: "Operating Temperature", value: "0°C to 50°C" },
{ label: "EHT", value: "500 V Nominal, Regulated" },
{ label: "Battery", value: "4 Penlight Dry Cells" },
{ label: "Dimensions", value: "140 x 65 x 50 mm + External Probe" },
{ label: "Weight", value: "Approx. 500 g including Battery and External Probe" },
{ label: "Display", value: "Graphic LCD with Backlight; CPS Display" },
],
features: [
"Detects Alpha, Beta, Gamma and X-ray radiation",
"Portable contamination monitoring design",
"Externally mounted pancake GM detector",
"Openable Alpha/Beta shield",
"Graphic LCD with backlight",
"CPS display capability",
"Menu-driven operation",
"Analogue bar for sudden radiation variations",
"Calibration-date indication",
